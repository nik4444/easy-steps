...
public class CustomGauge extends View {
    ...
    public CustomGauge(Context context, AttributeSet attrs) {
        ...
        setPointCenterColor(a.getColor(R.styleable.CustomGauge_gaugePointCenterColor, ContextCompat.getColor(context, android.R.color.white)));
        setPointCenterColor(a.getColor(R.styleable.CustomGauge_gaugePointStartColor, ContextCompat.getColor(context, android.R.color.white)));
...
//        mPaint.setShader(new LinearGradient(getWidth(), getHeight(), 0, 0, mPointEndColor ,mPointStartColor, Shader.TileMode.CLAMP));
        mPaint.setShader(new LinearGradient(0, 0, getWidth(), getHeight(),
                new int[] {
                        0xFF8BC34A,
                        0xFF277AA9,
                        0xFF277AA9,
                        0xFF277AA9 }, //substitute the correct colors for these
                new float[] {0.05f, 0.55f, 0.60f, 1},
    ...
    public void setPointCenterColor(int pointStartColor) {
        mPointStartColor = pointStartColor;
    }
