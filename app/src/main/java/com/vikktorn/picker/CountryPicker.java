...
public class CountryPicker
    ...
    public static final Country[] COUNTRIES = {
            new Country(231,"US", "United States", "+1", R.drawable.flag_us, "USD"),
            new Country(230,"GB", "United Kingdom", "+44", R.drawable.flag_gb, "GBP"),
            new Country(30,"BR", "Brazil", "+55", R.drawable.flag_br, "BRL"),
            new Country(10,"AR", "Argentina", "+54", R.drawable.flag_ar, "ARS"),
            new Country(229,"AE", "United Arab Emirates", "+971", R.drawable.flag_ae, "AED"),
    };
    // endregion
    ...
    CountryPicker(com.vikktorn.picker.CountryPicker.Builder builder) {
    ...
    public Country getCountryByName(@NonNull String countryName) {
        ...
        int i = Arrays.binarySearch(COUNTRIES, country, new com.vikktorn.picker.CountryPicker.NameComparator());
        if (i < 0) {
            return null;
        } else {
            return COUNTRIES[i];
    ...
    public Country getCountryByISO(@NonNull String countryIsoCode) {
        ...
        int i = Arrays.binarySearch(COUNTRIES, country, new com.vikktorn.picker.CountryPicker.ISOCodeComparator());
        if (i < 0) {
            return null;
        } else {
            return COUNTRIES[i];
    ...
    public static class Builder {
        ...
        public com.vikktorn.picker.CountryPicker.Builder with(@NonNull Context context) {
            this.context = context;
            return this;
        }

        public com.vikktorn.picker.CountryPicker.Builder sortBy(@NonNull int sortBy) {
            this.sortBy = sortBy;
            return this;
        }

        public com.vikktorn.picker.CountryPicker.Builder listener(@NonNull OnCountryPickerListener onCountryPickerListener) {
            this.onCountryPickerListener = onCountryPickerListener;
            return this;
        }

        public com.vikktorn.picker.CountryPicker.Builder canSearch(@NonNull boolean canSearch) {
            this.canSearch = canSearch;
            return this;
        }

        public com.vikktorn.picker.CountryPicker build() {
            return new com.vikktorn.picker.CountryPicker(this);
        }
    }
    // endregion
